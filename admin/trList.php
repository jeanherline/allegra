...
<head>
    ...
    <title>Table Reservation List</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand"> Table Reservation List </a>
            ...
            <div class="main-content">
                <p class="category">Reservations / <strong>Table Reservation List</strong></p>
                <div class="row">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="editTR.php?table_reservation_id=<?php echo $table_reservation_id; ?>">
                                                    ...
                                                    if ($status == "Pending") {
                                                    ?>
                                                        <a href="doneTR.php?table_reservation_id=<?php echo $table_reservation_id; ?>">
