        ...
        ?>
                ...
                <div id="content">
                    ...
                    <div class="top-navbar">
                        <nav class="navbar navbar-expand-lg">
                            <div class="container-fluid">
                                ...
                                <a class="navbar-brand"> Hero Banner </a>
                    ...
                    <div class="main-content">
                        <p class="category">Home / <strong>Hero Banner</strong></p>
                        <div class="row">
                            <div class="container">
                                <br>
                                <?php
                                ...
                                <form action="" method="POST" autocomplete="on" enctype="multipart/form-data">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $button_text = isset($_POST['button_text']) ? $_POST['button_text'] : $button_text;
                                        $button_link = isset($_POST['button_link']) ? $_POST['button_link'] : $button_link;

                                        $query = "UPDATE herobanner SET
                                            background_image = '$image',
                                            heading = '$heading',
                                            subheading= '$subheading',
                                            button_text= '$button_text',
                                            button_link= '$button_link'
                                        WHERE herobanner_id = 1";
                        ...
                        ?>
                            ...
                            <div id="content">
                                ...
                                <div class="main-content">
                                    <p class="category">Menu / <strong>Hero Banner</strong></p>
                                    <div class="row">
                                        <div class="container">
                                            <br>
                                            <?php
                                            ...
                                            <form action="" method="POST" autocomplete="on" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST['submit'])) {
                                                    ...
                                                    $query = "UPDATE edit_menu SET
                                                        heading = '$heading',
                                                        subheading= '$subheading',
                                                        banner= '$banner'
                                                    WHERE edit_menu_id = 1";
